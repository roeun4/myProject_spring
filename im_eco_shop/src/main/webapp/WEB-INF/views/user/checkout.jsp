...
<style>
	...
	.title-text{border: none; font-size: 18px; text-align: center;}
</style>

<div class="container w-75 mt-5">
	<h3 class="text-center mb-3">주문 / 결제</h3>
	<table class="table text-center">
		...
		<c:forEach var="dto" items="${sessionScope.dtos}">
			<tr>
				<td>
					<input type="checkbox" name="chk" value="${dto.pnum}"/>
				</td>
				<td>
	...
	<!-- 장바구니 총액 표시 -->
	<div class="text-end" style="line-height: 30px;">
    ...
    <table class="table">
       <thead>
          <tr>
             <th class="title-text" style="padding-top: 40px;">구매자 정보</th>
          </tr>
       </thead>
       <tbody>
          <tr>
          ...
          <tr>
             <td class="title-text" style="padding-top: 40px;"><b>받는사람 정보</b></td>
          </tr>
          <tr>
             <td>이름</td>
             <td>${mDto.name}</td>
          ...
          <tr>
             <td class="title-text" style="padding-top: 40px;"><b>결제정보</b></td>
          </tr>
          <tr>
             <td>총 주문금액</td>
